...
# User query
query = """
I have the TechGear Laptop running the Linux and having trouble with the video driver.  Where are the current video driver downloads?

Vicky
victoriaashworth@example.com
"""
